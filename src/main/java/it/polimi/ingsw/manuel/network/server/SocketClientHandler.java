...
public class SocketClientHandler implements ClientHandler, Runnable {
    ...
    public SocketClientHandler(SocketServer socketServer, Socket client) {
        ...
        try {
            this.output = new ObjectOutputStream(client.getOutputStream()); //SERVER'S OUTPUT TO CLIENT
            this.input = new ObjectInputStream(client.getInputStream());    //SERVER'S INPUT FROM CLIENT
        } catch (IOException e) {
